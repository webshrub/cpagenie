...
import com.webshrub.cpagenie.server.job.CPAGenieImpressionReportJob;
 ...
 * Time: 11:32:46 AM
 */
public class CPAGenieImpressionReportLoader {
    private CPAGenieJobManager jobManager;
    private Integer repeatDurationInMinutes;

    public CPAGenieImpressionReportLoader(Integer repeatDurationInMinutes) throws SchedulerException {
        ...
        scheduler.start();
        JobDetail jobDetail = new JobDetail(CPAGenieJobConstants.IMPRESSION_REPORT_LOADER_JOB_DETAIL_KEY, Scheduler.DEFAULT_GROUP, CPAGenieImpressionReportJob.class);
        SimpleTrigger simpleTrigger = new SimpleTrigger(CPAGenieJobConstants.IMPRESSION_REPORT_LOADER_TRIGGER_KEY,
                Scheduler.DEFAULT_GROUP, getRunTime(CPAGenieJobConstants.IMPRESSION_REPORT_LOADER_JOB_NAME), null, SimpleTrigger.REPEAT_INDEFINITELY, repeatDurationInMinutes * 60L * 1000L);
