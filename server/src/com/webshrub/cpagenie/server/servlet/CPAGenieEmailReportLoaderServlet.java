...
import com.webshrub.cpagenie.server.job.loader.CPAGenieEmailReportLoader;
 ...
 * Time: 11:41:28 PM
 */
public class CPAGenieEmailReportLoaderServlet extends GenericServlet {
    private static final int REPEAT_DURATION_IN_MINUTES = 24 * 60 * 60;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            new CPAGenieEmailReportLoader(repeatDurationInMinutes);
