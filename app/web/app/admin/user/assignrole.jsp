...
<div>
    <div>
        ...
        <a class="tabNormal" href="assignrole.htm"><span>Assign Role</span></a>
    </div>
    <div id="boxes" class="ui-widget box Top">
        <spring-form:form method="POST" action="assignrole.htm" modelAttribute="userAuthorityMapping">
            <table class="ui-widget ui-widget-content">
                <tbody>
                <tr>
                    <td style="width:200px;">User:</td>
                    <td>
                        <spring-form:select path="user" id="authorityUserSelect">
                ...
                <tr>
                    ...
                    <td>
                        <table id="userAuthorityListTable">
                            <tbody>
                            </tbody>
                        </table>
                    </td>
